    ...
    public class GrpcAuctionClient
    {
        ...
        public Auction GetAuction(string id)
        {
            ...
            try
            {
                ...
                {
                    ID = reply.Auction.Id,
                    AuctionEnd = DateTime.Parse(reply.Auction.AuctionEnd), //we have parsed here date because we are sending as string in AuctionService as GRPC doesnot support DateTime
